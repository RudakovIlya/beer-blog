...
describe('clsx', () => {
  ...
  test('expect some-class with mods: active-class hover', () => {
    expect(clsx(fistClass, { 'active-class': true, hover: true })).toBe('some-class active-class hover')
  })
  test('expect some-class with mods: active-class and without hover', () => {
    expect(clsx(fistClass, { 'active-class': true, hover: undefined })).toBe('some-class active-class')
  })
  test('expect some-class with additions classes', () => {
    expect(clsx(fistClass, {}, 'second-class', 'third-class')).toBe('some-class second-class third-class')
  })
})
